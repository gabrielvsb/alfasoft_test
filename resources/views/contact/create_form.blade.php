...
@section('content')
    ...
    <form method="POST" action="/contact/store">
        ...
        <div class="mb-3">
            ...
            <input class="form-control" name="name" id="name" type="text" placeholder="Jorge Alfasoft">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input class="form-control" name="contact" id="contact" type="text" placeholder="Ex: 999999999">
        </div>
